...
# If true, skip KG/graph extraction entirely at ingestion time. Ingestion stays
# tree-only (parse → chunk → embed → index), so there is no background LLM load
# competing with live chat for Azure OpenAI quota. Retrieval auto-falls back to
